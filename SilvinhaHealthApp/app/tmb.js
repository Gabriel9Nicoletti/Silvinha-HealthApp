      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <View style={styles.content}>
          ...
          <Text style={styles.description}>
            TMB é a quantidade mínima de calorias que seu corpo precisa para manter as funções vitais em repouso.
          </Text>
...
const styles = StyleSheet.create({
  ...
  content: { padding: 20 },
  title: { fontSize: 28, fontWeight: 'bold', marginBottom: 10, textAlign: 'center', color: '#96CEB4' },
  description: { fontSize: 14, color: '#666', textAlign: 'center', marginBottom: 30, lineHeight: 20 },
  ...
  sexContainer: { flexDirection: 'row', justifyContent: 'space-around', marginBottom: 30, marginTop: 10 },
  sexButton: { flex: 1, padding: 15, marginHorizontal: 5, borderRadius: 10, borderWidth: 2, borderColor: '#96CEB4', alignItems: 'center', backgroundColor: '#fff' },
  sexButtonSelected: { backgroundColor: '#96CEB4' },
  sexIcon: { fontSize: 30, marginBottom: 5 },
  sexText: { fontSize: 14, color: '#96CEB4', fontWeight: '600' },
  sexTextSelected: { color: '#fff' },
  button: { backgroundColor: '#96CEB4', padding: 18, borderRadius: 10, alignItems: 'center', marginTop: 10, shadowColor: '#96CEB4', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 5, elevation: 5 },
  buttonText: { color: '#fff', fontSize: 18, fontWeight: '600' },
  resultBox: { marginTop: 30, padding: 25, backgroundColor: '#fff', borderRadius: 15, alignItems: 'center', borderWidth: 2, borderColor: '#96CEB4' },
  resultLabel: { fontSize: 16, color: '#666', marginBottom: 10 },
  resultValue: { fontSize: 40, fontWeight: 'bold', color: '#96CEB4', marginBottom: 20 },
  infoBox: { width: '100%', padding: 15, backgroundColor: '#f5f5f5', borderRadius: 10 },
  infoTitle: { fontSize: 16, fontWeight: '600', color: '#333', marginBottom: 10, textAlign: 'center' },
