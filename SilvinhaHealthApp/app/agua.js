            ...
            <ScrollView contentContainerStyle={styles.scrollContent}>
                <View style={styles.content}>
                    ...
                    <Text style={styles.description}>
                        A recomendação geral é consumir 35ml de água por kg de peso corporal.
                    </Text>
                    ...
                    {resultado && (
                        <View style={styles.resultBox}>
                            ...
                            <View style={styles.tipsContainer}>
                                ...
                                <Text style={styles.tip}>• Tenha uma garrafa sempre por perto</Text>
...
const styles = StyleSheet.create({
    ...
    content: { padding: 20 },
    title: { fontSize: 28, fontWeight: 'bold', marginBottom: 10, textAlign: 'center', color: '#45B7D1' },
    description: { fontSize: 14, color: '#666', textAlign: 'center', marginBottom: 20, lineHeight: 20 },
    waterIcon: { alignItems: 'center', marginBottom: 20 },
    waterEmoji: { fontSize: 80 },
    ...
    button: { backgroundColor: '#45B7D1', padding: 18, borderRadius: 10, alignItems: 'center', marginTop: 10, shadowColor: '#45B7D1', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 5, elevation: 5 },
    buttonText: { color: '#fff', fontSize: 18, fontWeight: '600' },
    resultBox: { marginTop: 30, padding: 25, backgroundColor: '#fff', borderRadius: 15, alignItems: 'center', borderWidth: 2, borderColor: '#45B7D1' },
    resultLabel: { fontSize: 16, color: '#666', marginBottom: 10 },
    resultValue: { fontSize: 40, fontWeight: 'bold', color: '#45B7D1' },
    resultSecondary: { fontSize: 18, color: '#666', marginBottom: 20 },
    tipsContainer: { width: '100%', marginTop: 15, paddingTop: 15, borderTopWidth: 1, borderTopColor: '#eee' },
    tipsTitle: { fontSize: 16, fontWeight: '600', color: '#333', marginBottom: 10 },
    tip: { fontSize: 14, color: '#666', marginBottom: 5 },
});